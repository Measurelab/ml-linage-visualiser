...
const DataUpload: React.FC<DataUploadProps> = ({ onUploadComplete, isSupabaseEnabled }) => {
  ...
  const handleGenerateVisualization = async () => {
    ...
    try {
      ...
      // Import to project
      await importParsedDataToProject(parsedData, project.id);
      onUploadComplete(project, parsedData);
    } catch (error) {
...
TBL004,revenue_dashboard,analytics,Target,Query,No,,Revenue metrics for dashboard`;
      ...
      case 'lineage':
        ...
        content = `Target_Table_ID,Source_Table_ID,Target_Table_Name,Source_Table_Name
...
DASH002,TBL003,User Metrics,user_orders`;
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-semibold mb-2">Create New Project (CSV Upload)</h1>
        <p className="text-muted-foreground">
          Upload your 4 CSV files to create a new lineage visualization project.
        </p>
      </div>
      ...
      <div className="flex justify-center">
        <Button
          ...
          disabled={!allFilesValid || uploading || !projectName.trim()}
