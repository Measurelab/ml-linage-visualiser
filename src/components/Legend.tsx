  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          <p className="text-xs font-medium text-muted-foreground mb-2">Table types</p>
        ...
        <div>
          <p className="text-xs font-medium text-muted-foreground mb-2">Special indicators</p>
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <div className="relative">
                <div className="w-3 h-3 bg-primary rounded-full"></div>
                <div className="absolute inset-0 w-4 h-4 -top-0.5 -left-0.5 border border-primary rounded-full border-dashed"></div>
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs">Dashboard highlight</span>
            </div>
          </div>
        </div>
        ...
        <div className="pt-2 border-t">
          <p className="text-xs text-muted-foreground">
            <strong>Tips:</strong> Click and drag to pan, scroll to zoom, click nodes for details
          </p>
        </div>
      </CardContent>
    </Card>
